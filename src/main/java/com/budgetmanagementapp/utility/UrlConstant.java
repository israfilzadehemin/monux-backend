...
public class UrlConstant {
    ...
    public static final String TRANSACTION_GET_LAST_TRANSACTIONS_URL = "/v1/transaction/get-last-transactions/{page-count}";
    public static final String TRANSACTION_GET_LAST_TRANSACTIONS_BY_ACCOUNT_URL = "/v1/transaction/get-last-transactions-by-account/{page-count}";
