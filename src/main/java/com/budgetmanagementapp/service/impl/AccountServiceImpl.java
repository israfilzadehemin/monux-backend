...
public class AccountServiceImpl implements AccountService {
    ...
    public AccountResponseModel updateAccount(UpdateAccountModel accountModel, String username) {
        ...
        Account account = accountByIdAndUser(accountModel, username);
    ...
    private Account accountByIdAndUser(UpdateAccountModel accountModel, String username) {
        return accountRepo
                .byIdAndUser(accountModel.getAccountId(), userService.findByUsername(username))
